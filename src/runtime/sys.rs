...
fn bindgen_test_layout_cudaTextureDesc_v2() {
    const UNINIT: ::core::mem::MaybeUninit<cudaTextureDesc_v2> = ::core::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::core::mem::size_of::<cudaTextureDesc_v2>(),
        72usize,
        concat!("Size of: ", stringify!(cudaTextureDesc_v2))
    );
    assert_eq!(
        ::core::mem::align_of::<cudaTextureDesc_v2>(),
        4usize,
